...
const RedBanner = ({title, text, iconArray}) =>{
    
    return(<React.Fragment>
        <div className="container-fluid redbanner-container">
            <div className="row">
                <div className="col-lg-12 col-xl-6 container-icons">
                    <div className="div-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 176 120" width="66px" heigth="45px">
                            <title>PC - Mac</title>
                    ...
                    <div className="div-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" width="45px" heigth="45px">
